		...
		<table id="support_table">
			<tr>
				<td class="support_table_sx">
					...
					<table class="support_internal" cellpadding="0" cellspacing="0">
						<tr valign="top">
							<!--<td width="40%">
							...
							<td width="35%">
								...
								<ul class="">
									<li>If you like the plugin, please consider donating with paypal</li>
                            ...
                            <td width="30%">
                                <div class="side_box_left">
                                    <h4 class="syg_sidebar_title">Social Media</h4>
                                    <p>
                                        <!-- Gplus badge start -->
                                        <!-- Inserisci questo tag nel punto in cui vuoi che sia visualizzato l'elemento widget. -->
                                    <div class="g-person" data-width="302" data-href="//plus.google.com/105130254942884699402" data-theme="dark" data-layout="landscape" data-rel="author"></div>
                            ...
                            <td>
                                <div class="side_box_right_top">
                                    <h4 class="syg_sidebar_title">If you enjoy it, please donate.</h4>
                                    <p>Many hours of works has been spent into making Sliding YouTube Gallery a useful, elegant and stable plugin.</p><p>If you like this project and want to show me your appreciation then please donate.</p><p>Donation are crucial to continue the development of open source software.</p>
                                ...
                                <div class="side_box_right_bottom">
                                    <h4 class="syg_sidebar_title">Quick resources</h4>
                                    <ul>
