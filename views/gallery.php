...
<?php 
// js to include
$url = WP_PLUGIN_URL.'/sliding-youtube-gallery/js/core/ui/ready/syg.client.js.php?id='.$gallery->getId().'&ui='.SygConstant::SYG_PLUGIN_COMPONENT_GALLERY;
...
// js to include
$url = WP_PLUGIN_URL.'/sliding-youtube-gallery/js/core/ui/loading/gallery.js.php?id='.$gallery->getId();
