...
class SygConstant {
	 ...
	 */
	const SYG_OPTION_DEFAULT_PAGINATOR_BORDERRADIUS = '0';
	const SYG_OPTION_DEFAULT_PAGINATOR_BORDERSIZE = '1';
	const SYG_OPTION_DEFAULT_PAGINATOR_BORDERCOLOR = '#333333';
	const SYG_OPTION_DEFAULT_PAGINATOR_BGCOLOR = '#ffffff';
	const SYG_OPTION_DEFAULT_PAGINATOR_SHADOWCOLOR = '#000000';
	const SYG_OPTION_DEFAULT_PAGINATOR_SHADOWSIZE = '0';
	const SYG_OPTION_DEFAULT_PAGINATOR_FONTCOLOR = '#000000';
