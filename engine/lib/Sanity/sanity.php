    ...
    */
    ...
    function cacheRender($id, $component) {
        ...
        if (SygConstant::SYG_PLUGIN_COMPONENT_GALLERY == $component) {
	        ...
	        // js to include
	        $url = WP_PLUGIN_URL.'/sliding-youtube-gallery/js/core/ui/loading/gallery.js.php?id='.$id;
        	...
        	// js to include
        	$url = WP_PLUGIN_URL.'/sliding-youtube-gallery/js/core/ui/loading/carousel.js.php?id='.$id;
        	wp_register_script('syg-action-'.$id, $url, array(), SygConstant::SYG_VERSION, true);
        	wp_enqueue_script('syg-action-'.$id);
        }
        return $output;
