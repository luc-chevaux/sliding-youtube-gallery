    ...
    */
    ...
    function cacheRender($id, $component) {
        ...
        if (SygConstant::SYG_PLUGIN_COMPONENT_GALLERY == $component) {
	        ...
	        // js to include
	        $url = WP_PLUGIN_URL.'/sliding-youtube-gallery/js/core/ui/gallery/action.js.php?id='.$id;
        	...
        	// js to include
        	$url = WP_PLUGIN_URL.'/sliding-youtube-gallery/js/syg.client.js.php?id='.$id.'&ui='.SygConstant::SYG_PLUGIN_COMPONENT_CAROUSEL;
