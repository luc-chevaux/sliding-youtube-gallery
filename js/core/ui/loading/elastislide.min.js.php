...
if(file_exists($target_dir.$name)) {
	...
	// generate files
	$js = file_get_contents(SYG_URL . 'js/core/ui/loading/elastislide.js.php?id='.$id);
	...
	if(isset($_REQUEST['minify'])) {
		...
		// $js.="setTimeout(function(){var a=document.createElement('img');a.src='" . SYG_URL . "js/core/ui/loading/elastislide.min.js.php?minify=1&id=".$id."';a.style.display='none';document.body.appendChild(a);},5000);";
		$url = SYG_URL . "js/core/ui/loading/elastislide.min.js.php";
		$js .= "(function($){
