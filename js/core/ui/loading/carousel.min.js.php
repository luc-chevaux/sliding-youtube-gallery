...
if(file_exists($writabledir.$name)) {
	...
	if(isset($_REQUEST['minify'])) {
		...
		$js.="setTimeout(function(){var a=document.createElement('img');a.src='carousel.min.js.php?minify=1&id=".$id."';a.style.display='none';document.body.appendChild(a);},5000);";
	}
	echo $js;
}
?>