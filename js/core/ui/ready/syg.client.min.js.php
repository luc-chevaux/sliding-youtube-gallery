...
if(file_exists($target_dir.$name)) {
	...
	// generate files
	$url = SYG_URL . 'js/core/ui/ready/syg.client.js.php?id='.$id;	
	// check parameters 
	...
	if(isset($_REQUEST['minify'])) {
		...
		//$js .= "setTimeout(function(){var a=document.createElement('img');a.src='" . SYG_URL . "js/core/ui/ready/syg.client.min.js.php?minify=1&id=".$id."&ui=".$uiType."&cache=".$cache."';a.style.display='none';document.body.appendChild(a);},5000);";
		$url = SYG_URL . "js/core/ui/ready/syg.client.min.js.php";
		$js .= "(function($){
