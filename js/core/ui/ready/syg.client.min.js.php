...
if(file_exists($writabledir.$name)) {
	...
	if(isset($_REQUEST['minify'])) {
		...
		$js.="setTimeout(function(){var a=document.createElement('img');a.src='" . WP_PLUGIN_URL . SygConstant::WP_JS_PATH . "core/ui/ready/syg.client.min.js.php?minify=1&id=".$id."&ui=".$uiType."&cache=".$cache."';a.style.display='none';document.body.appendChild(a);},5000);";
	}
	echo $js;
}
?>