...
if(file_exists($target_dir.$name)) {
	...
	// generate files
	$js .= file_get_contents(WP_PLUGIN_URL . SygConstant::WP_JS_PATH . 'core/lib/syg.lib.admin.js.php?id='.$id);
	...
	if(isset($_REQUEST['minify'])) {
		...
		$js.="setTimeout(function(){var a=document.createElement('img');a.src='" . WP_PLUGIN_URL . SygConstant::WP_JS_PATH . "core/lib/syg.lib.admin.min.js.php?minify=1';a.style.display='none';document.body.appendChild(a);},5000);";
	}
	echo $js;
}
?>